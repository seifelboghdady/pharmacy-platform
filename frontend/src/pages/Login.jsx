...
export default function Login() {
  ...
  const handleSubmit = async (ev) => {
    ...
    try {
      ...
      const response = await fetch(
        "https://pharmteck.up.railway.app/api/users/login",
        {
          method: "POST",
          headers: {
  ...
  return (
    ...
    >
      <div
        className="auth-left d-none d-md-flex"
        style={{ width: "42%", position: "relative", overflow: "hidden" }}
      >
        <div
          style={{
            position: "absolute",
        ...
        >
          ...
          <div style={{ marginTop: "3rem", maxWidth: 280 }}>
            <h4 style={{ fontWeight: 600 }}>
              Monitor Your Pharmacy From Anywhere
            </h4>
            ...
            >
              Access your inventory, orders, and analytics from any device,
              anytime.
            </p>
          </div>
        </div>
